...
import interfaces.RandomCodeQualityPolicyFetcher;
import jade.core.Agent;
import java.util.logging.Level;
import java.util.logging.Logger;
import myjadeinit.behaviours.AbstractReceiveMessage;
import myjadeinit.behaviours.Defactor;
import myjadeinit.behaviours.Refactor;
...
public class SourceCode extends Agent {
    ...
    private class ReceiveMessage extends AbstractReceiveMessage implements RandomCodeQualityPolicyFetcher {
            ...
            if (aclmessage != null) {
                ...
                if (message.contains(RANDOM_REFACTORING)) {
                    ...
                    try {
                        ...
                        Logger.getLogger(myjadeinit.actors.SourceCode.ReceiveMessage.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
